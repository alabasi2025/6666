...
export const customReceiptVouchers = mysqlTable("custom_receipt_vouchers", {
  ...
  currency: varchar("currency", { length: 10 }).default("SAR"),
  // من أين (المصدر)
  sourceType: mysqlEnum("source_type", ["person", "entity", "intermediary", "other"]).notNull(),
...
export const customPaymentVouchers = mysqlTable("custom_payment_vouchers", {
  ...
  treasuryId: int("treasury_id").notNull(),
  // إلى أين (الوجهة)
  destinationType: mysqlEnum("destination_type", ["person", "entity", "intermediary", "other"]).notNull(),
