...
## نظام الموارد البشرية (HR System) - قيد التنفيذ
...
- [ ] ربط field_workers بجدول employees
...
## تحسين معلومات الشاشات (Info Button) - قيد التنفيذ
- [x] إنشاء مكون EngineInfoDialog القابل لإعادة الاستخدام
- [x] إنشاء ملف pageInfoRegistry.ts لتخزين معلومات جميع الشاشات
- [x] إضافة زر المعلومات في جميع الشاشات الرئيسية (Dashboard, Home, Login, Register, CustomSystem)
- [x] تحسين معلومات 15 شاشة رئيسية بالتفاصيل الكاملة:
  - [x] الشركات
  - [x] العملاء
  - [x] الفواتير
  - [x] القراءات
  ...
  - [x] أرصدة المخزون
  - [x] أوامر الشراء
  - [x] SCADA - لوحة المراقبة
  - [x] المشاريع
  - [x] الموارد البشرية - الموظفين
- [ ] تحسين معلومات ~75 شاشة متبقية بالتفاصيل الكاملة (لاحقاً):
  - [ ] SCADA (التنبيهات، الحساسات، الكاميرات)
  - [ ] المشاريع (مخطط جانت، المهام)
  - [ ] الموارد البشرية (الأقسام، الحضور، الإجازات، الرواتب)
  - [ ] العمليات الميدانية
  - [ ] الديزل
  - [ ] النظام المخصص
  - [ ] التقارير
