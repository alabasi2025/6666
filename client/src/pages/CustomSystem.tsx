...
import {
  ...
  ArrowLeft, ArrowLeftRight, FileCheck, BookOpen, Package, Users, ShoppingCart, Tags, Coins, BarChart3
} from "lucide-react";
  ...
  // النظام المالي - مجموعة
  {
    ...
    children: [
      ...
      },
      {
        ...
        icon: BarChart3,
        description: "رصيد مدين/دائن للفترة",
        color: "from-emerald-500 to-green-500",
      },
    ],
  },
                              ...
                              {item.children.map((child: any) => {
                                ...
                                const getChildColorClasses = () => {
                                  switch(child.id) {
                                    ...
                                    case 'ledger-report':
                                      return {
                                        activeBg: 'bg-gradient-to-l from-sky-500 to-blue-500',
